...
async def test_restart_monitoring_grace_period_detects_all_channels(mock_coordinator, mock_config_entry):
    ...
    ***REMOVED*** Simulate channel counts increasing over time: 1 -> 2 -> 4 upstream
    channel_progression = [
    ...
    ***REMOVED*** Mock the restart monitoring function
    ***REMOVED*** We're testing the logic, not the full integration
    ***REMOVED*** Check that the pattern exists in the code
    import inspect
