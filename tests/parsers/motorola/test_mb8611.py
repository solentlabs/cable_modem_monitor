...
***REMOVED*** Detection tests
def test_detects_from_model_name():
...
def test_detects_from_model_number_with_spaces():
...
def test_detects_from_serial_number():
...
def test_detects_from_hnap_with_motorola():
...
def test_does_not_detect_other_modems():
...
def test_does_not_detect_hnap_without_motorola():
...
def test_url_patterns_require_hnap_auth():
...
def test_login_uses_auth_factory():
...
***REMOVED*** HNAP parsing tests
def test_parse_requires_session_and_base_url():
...
def test_parse_downstream_channels(mock_builder_class, hnap_full_status):
...
@patch('custom_components.cable_modem_monitor.parsers.motorola.mb8611.HNAPRequestBuilder')
def test_parse_upstream_channels(mock_builder_class, hnap_full_status):
...
@patch('custom_components.cable_modem_monitor.parsers.motorola.mb8611.HNAPRequestBuilder')
def test_parse_system_info(mock_builder_class, hnap_full_status):
...
@patch('custom_components.cable_modem_monitor.parsers.motorola.mb8611.HNAPRequestBuilder')
def test_hnap_builder_called_correctly(mock_builder_class, hnap_full_status):
...
@patch('custom_components.cable_modem_monitor.parsers.motorola.mb8611.HNAPRequestBuilder')
def test_parse_handles_invalid_json(mock_builder_class):
...
@patch('custom_components.cable_modem_monitor.parsers.motorola.mb8611.HNAPRequestBuilder')
def test_parse_handles_missing_downstream_data(mock_builder_class):
...
@patch('custom_components.cable_modem_monitor.parsers.motorola.mb8611.HNAPRequestBuilder')
def test_parse_handles_malformed_channel_entry(mock_builder_class):
...
@patch('custom_components.cable_modem_monitor.parsers.motorola.mb8611.HNAPRequestBuilder')
def test_parse_handles_exception_in_builder(mock_builder_class):
...
def test_parse_downstream_handles_empty_hnap_data():
...
def test_parse_upstream_handles_empty_hnap_data():
...
def test_parse_system_info_handles_empty_hnap_data():
