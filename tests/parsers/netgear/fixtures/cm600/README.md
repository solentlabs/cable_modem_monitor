...
- [Related Issue: #3](https://github.com/kwschulz/cable_modem_monitor/issues/3)
...
- **Original Issue**: [#3 - Netgear CM600 Login Doesn't Work](https://github.com/kwschulz/cable_modem_monitor/issues/3)
