...
def test_parser_system_info(cm600_router_status_html):
    ...
    ***REMOVED*** Verify system info was extracted
    ...
    ***REMOVED*** Check hardware version if available
...
def test_parsing_downstream(cm600_docsis_status_html):
    ...
    ***REMOVED*** Verify downstream channels were parsed
    ...
    assert len(data["downstream"]) == 8  ***REMOVED*** CM600 has 8 downstream channels in this fixture

    ***REMOVED*** Check first downstream channel
    first_ds = data["downstream"][0]
    assert first_ds["channel_id"] == "1"
    assert first_ds["frequency"] == 141000000  ***REMOVED*** 141 MHz in Hz
    assert first_ds["power"] == -5.0  ***REMOVED*** dBmV
    assert first_ds["snr"] == 41.9  ***REMOVED*** dB
    ...
    ***REMOVED*** Check second channel to verify parsing continues correctly
    ...
    assert second_ds["frequency"] == 147000000  ***REMOVED*** 147 MHz
...
def test_parsing_upstream(cm600_docsis_status_html):
    ...
    ***REMOVED*** Verify upstream channels were parsed
    ...
    assert len(data["upstream"]) == 4  ***REMOVED*** CM600 has 4 upstream channels in this fixture

    ***REMOVED*** Check first upstream channel
    first_us = data["upstream"][0]
    assert first_us["channel_id"] == "1"
    assert first_us["frequency"] == 13400000  ***REMOVED*** 13.4 MHz in Hz
    assert first_us["power"] == 50.0  ***REMOVED*** dBmV
