...
from custom_components.cable_modem_monitor.parsers.arris_sb6141 import ArrisSB6141Parser
...
def arris_signal_html():
    ...
    fixture_path = os.path.join(
        os.path.dirname(__file__), "fixtures", "arris_sb6141", "arris_sb6141_signal.html"
    )
