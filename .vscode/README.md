***REMOVED*** VSCode Configuration Guide
...
***REMOVED******REMOVED*** Files Overview
...
***REMOVED******REMOVED******REMOVED*** Option 1: Workspace File (Recommended)
...
***REMOVED******REMOVED******REMOVED*** Option 2: Folder
...
***REMOVED******REMOVED*** Recommended Extensions

When you open the project, VS Code will suggest installing these extensions:

***REMOVED******REMOVED******REMOVED*** Python Development
...
***REMOVED******REMOVED******REMOVED*** Testing Conflicts
...
***REMOVED******REMOVED******REMOVED*** Formatter Conflicts
...
***REMOVED******REMOVED*** Quick Access Tasks

Press `Ctrl+Shift+P` (or `Cmd+Shift+P` on Mac) → **"Tasks: Run Task"**

***REMOVED******REMOVED******REMOVED*** Validation Tasks (Before Commit/PR)
...
***REMOVED******REMOVED******REMOVED*** Code Quality Tasks
- **Lint Code** - Check code with Ruff
- **Format Code** - Auto-format with Black

***REMOVED******REMOVED******REMOVED*** Home Assistant Tasks
...
***REMOVED******REMOVED*** Settings Explained
...
***REMOVED******REMOVED******REMOVED*** File Settings
...
***REMOVED******REMOVED******REMOVED*** Debug Current File

1. Open a Python file
2. Press `F5`
3. Select "Python: Current File"

***REMOVED******REMOVED******REMOVED*** Debug Tests
...
***REMOVED******REMOVED******REMOVED*** Linux / Chrome OS
- Python path: `.venv/bin/python` (VS Code handles automatically)
- Native terminal
...
***REMOVED******REMOVED*** Extension Conflict Detection
...
***REMOVED******REMOVED******REMOVED*** "Tests not showing"
...
***REMOVED******REMOVED******REMOVED*** "Tasks not appearing"
1. Press `Ctrl+Shift+P`
2. Type "Tasks: Run Task"
3. If empty, reload window

***REMOVED******REMOVED******REMOVED*** "Extension conflicts"
...
```bash
***REMOVED*** Option 1: Use Make
make validate

***REMOVED*** Option 2: Use VS Code task
***REMOVED*** Ctrl+Shift+P → Tasks → "🚀 Quick Validation"
```
...
***REMOVED******REMOVED******REMOVED*** Before Pull Request
...
***REMOVED*** Option 2: Use VS Code task
***REMOVED*** Ctrl+Shift+P → Tasks → "🔍 Full CI Validation"
```
...
***REMOVED******REMOVED*** Settings Precedence
