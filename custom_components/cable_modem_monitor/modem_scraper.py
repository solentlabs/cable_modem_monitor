...
class ModemScraper:
    ...
    def get_modem_data(self) -> dict:
        ...
        try:
            ...
            # Build result with parser-provided system info
            result = {
            ...
            # For Motorola modems, try to fetch additional data from MotoHome.asp
            # This is Motorola-specific and should eventually move into the Motorola parser
