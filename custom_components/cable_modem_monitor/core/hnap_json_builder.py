...
class HNAPJsonRequestBuilder:
    ...
    def login(self, session: requests.Session, base_url: str, username: str, password: str) -> tuple[bool, str]:
        ...
        try:
            ...
            ***REMOVED*** Try to parse JSON response to check for errors
            try:
                response_json = json.loads(response.text)

                ***REMOVED*** Check for login result
                ...
                ***REMOVED*** If we can't parse JSON, treat non-error HTTP status as success
                _LOGGER.warning(
