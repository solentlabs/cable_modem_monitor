***REMOVED*** Feature Request: Phase 4 - Data-Driven JSON Configs
...
***REMOVED******REMOVED******REMOVED*** JSON Parser Configuration Format
...
***REMOVED******REMOVED******REMOVED*** Generic Parser Implementation
...
***REMOVED******REMOVED******REMOVED*** Example HTML Parser JSON
...
***REMOVED******REMOVED*** Community Workflow
...
***REMOVED******REMOVED*** Alternative Considered: Python with Simplified API
