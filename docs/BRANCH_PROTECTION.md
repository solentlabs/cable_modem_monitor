...
### 3. Required Settings for Main Branch
...
### Problem: Can't find status check names
...
### Problem: Pull requests can still be merged without checks
...
### Problem: Administrators can bypass rules
