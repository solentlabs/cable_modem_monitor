...
#### 1.1 Line Length Configuration (`pyproject.toml`)
...
#### 1.2 Remove `verify_ssl` User Setting
- **Commit**: `263fd21`
...
#### 2.1 Blocking I/O in Event Loop (SSL Context)
...
#### 2.2 Missing Config Entry Parameter
- **Commit**: `4b29451`
...
#### 2.3 Excessive Logging (200+ messages)
- **Commit**: `969d3af`
...
#### 2.5 Platform Unload Error Handling
- **Commit**: `4bd3578`
...
#### 3.1 Show Detected Modem in Messages
...
#### 3.2 Fix Duplicate Manufacturer Names
- **Commit**: `1df6c90`
...
#### 3.3 Improved Restart Monitoring
- **Commit**: `78b3c37`
...
#### 3.4 Enhanced Channel Synchronization Detection
