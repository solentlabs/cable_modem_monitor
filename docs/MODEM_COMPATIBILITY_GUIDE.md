...
- **Technicolor TC4400** - Parser has 95% test coverage, but some users report entity availability issues (Issue ***REMOVED***1). Awaiting debug logs from affected users.
- **Arris SB6183**
- **Arris SB8200**

***REMOVED******REMOVED******REMOVED*** 🧪 Experimental / Newly Implemented (Awaiting Confirmation)
...
- **Netgear CM600** - ✨ NEW in v3.3.0! Full JavaScript-based parser with comprehensive test coverage. Awaiting user confirmation (Issue ***REMOVED***3).
