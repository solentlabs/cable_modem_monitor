***REMOVED*** HTML Capture Guide for Unsupported Modems

This guide helps you capture HTML from your modem to help developers add support for your model.

***REMOVED******REMOVED*** For Users WHO CAN Install the Integration
...
***REMOVED******REMOVED******REMOVED*** What Gets Captured:
...
***REMOVED******REMOVED*** For Users WHO CANNOT Install the Integration
...
***REMOVED******REMOVED*** What Information is Removed?
...
***REMOVED******REMOVED*** For Netgear CM600 Users Specifically
...
```bash
***REMOVED*** Download and run the capture script
python3 tools/capture_modem_html.py

***REMOVED*** When prompted:
***REMOVED*** - IP: 192.168.100.1
***REMOVED*** - Username: (press Enter - usually not needed)
***REMOVED*** - Password: (press Enter - usually not needed)

***REMOVED*** Attach the generated ZIP file to GitHub Issue ***REMOVED***3
```
...
***REMOVED******REMOVED*** Privacy and Security

***REMOVED******REMOVED******REMOVED*** What We Do:
...
***REMOVED******REMOVED******REMOVED*** What We Don't Do:
❌ No telemetry or tracking
❌ No automatic uploads
❌ No storage of sensitive data
❌ No third-party services

***REMOVED******REMOVED******REMOVED*** You're Always in Control:
