...
| [HNAP](https://en.wikipedia.org/wiki/Home_Network_Administration_Protocol)/API modems (MB8611, S33, etc.) | [HAR Capture Script](***REMOVED***method-2-har-capture-script) **required** |
