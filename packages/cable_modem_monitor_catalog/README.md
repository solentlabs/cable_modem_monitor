...
**Supported Modems:** 32 (1 ✅ confirmed, 31 ⏳ awaiting)

**Auth strategies:** form (11), none (6), hnap (6), basic (4), form_pbkdf2 (2), url_token (1), form_sjcl (1), form_cbn (1)
...
---
*Generated by `scripts/generate_catalog_index.py` from 33 modem configs ([source](https://github.com/solentlabs/cable_modem_monitor/blob/main/packages/cable_modem_monitor_catalog/scripts/generate_catalog_index.py))*
