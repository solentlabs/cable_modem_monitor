"""Post-processor for Netgear CM600.

Extracts hardware_version and software_version from RouterStatus.asp.
...
class PostProcessor:
    """RouterStatus.asp system_info extractor for CM600."""
    ...
    def parse_system_info(
        ...
        """
        soup = resources.get("/RouterStatus.asp")
        if soup is None:
            return system_info
