...
See [PARSING_SPEC.md](../../cable_modem_monitor_core/docs/PARSING_SPEC.md#field-guarantees)
for canonical field definitions and guarantees.

This document owns **Tier 2 registered fields** — standardized names
for pass-through fields that multiple modems expose. The Catalog
maintains this registry because it grows with the modem collection.
