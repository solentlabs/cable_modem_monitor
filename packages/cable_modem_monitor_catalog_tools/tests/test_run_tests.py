...
import pytest
from solentlabs.cable_modem_monitor_catalog_tools.run_tests import (
    run_tests,
)
...
_PIPELINE_FIXTURES = (
    Path(__file__).resolve().parent.parent.parent / "cable_modem_monitor_core" / "tests" / "fixtures" / "pipeline"
)
