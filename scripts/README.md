...
| `fresh-start.sh` | Reset VS Code state to test new developer experience (Linux/macOS) | 0: Success |
| `fresh-start.ps1` | Reset VS Code state to test new developer experience (Windows) | 0: Success |
