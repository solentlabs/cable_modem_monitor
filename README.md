...
| Model | Issue | Status |
|-------|-------|--------|
| **Netgear CM2000** | Authentication not working | See [Issue #38](https://github.com/kwschulz/cable_modem_monitor/issues/38) - Basic auth insufficient, CM600 parser works as workaround |
...
| **Motorola MB8611 (HNAP)** | HNAP authentication broken | See [Issues #4, #6](https://github.com/kwschulz/cable_modem_monitor/issues/4) - SSL cert and protocol issues |
