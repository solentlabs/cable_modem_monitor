...
| **Netgear CM600** | User verified ([Issue #3](https://github.com/kwschulz/cable_modem_monitor/issues/3)) | 24 DS / 6 US channels, system info, restart |
...
### Manual Way: Capture HTML (If needed)
